...
/***/ "./src/controls/content-visibility-specific-users-multiselect.js":
/*!***********************************************************************!*\
  !*** ./src/controls/content-visibility-specific-users-multiselect.js ***!
  \***********************************************************************/
/*! exports provided: ContentVisibilitySpecificUsersMultiSelect */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ContentVisibilitySpecificUsersMultiSelect", function() { return ContentVisibilitySpecificUsersMultiSelect; });
...
var ContentVisibilitySpecificUsersMultiSelect = Object(_wordpress_compose__WEBPACK_IMPORTED_MODULE_3__["withState"])({
  option: []
})(function (_ref) {
  ...
  var onChange = function onChange(option) {
    ...
    props.setAttributes({
      contentVisibilityRules: _objectSpread(_objectSpread({}, props.attributes.contentVisibilityRules), {}, {
        specificusers: _objectSpread(_objectSpread({}, props.attributes.contentVisibilityRules.specificusers), {}, _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_0___default()({}, type, option))
      })
    });
  };
...
/***/ "./src/controls/content-visibility-specific-users-panel-body.js":
/*!**********************************************************************!*\
  !*** ./src/controls/content-visibility-specific-users-panel-body.js ***!
  \**********************************************************************/
...
/* harmony import */ var _controls_content_visibility_specific_users_multiselect__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../controls/content-visibility-specific-users-multiselect */ "./src/controls/content-visibility-specific-users-multiselect.js");
...
function getUsers() {
  ...
  if (BlockVisibilitySpecificUsers.users.length === 0) {
    return [{
      label: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__["__"])('No users found.', 'content-visibility'),
      value: 0,
      notes: ''
    }];
  }

  for (var user in BlockVisibilitySpecificUsers.users) {
    users.push({
...
function ContentVisibilitySpecificUsersBodyControl(_ref) {
  var instanceId = _ref.instanceId,
      props = _ref.props;
  var data = getUsers();
  var type = 'specificusers';
  ...
  return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])(_wordpress_components__WEBPACK_IMPORTED_MODULE_1__["PanelBody"], {
    title: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__["__"])('Specific Users', 'content-visibility-specific-users'),
    initialOpen: false,
    className: "content-visibility-control-panel content-visibility-specific-users-controls" + hasRulesClass
  }, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])(_wordpress_components__WEBPACK_IMPORTED_MODULE_1__["PanelRow"], null, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])(_controls_content_visibility_specific_users_multiselect__WEBPACK_IMPORTED_MODULE_4__["ContentVisibilitySpecificUsersMultiSelect"], {
    data: data,
    ...
    className: "specific-users-help-intro content-visibility-help-text"
  }, Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__["__"])('Select one or more users to whom this block will be ' + props.attributes.contentVisibility + '. If no users are selected, this block will be ' + props.attributes.contentVisibility + ' to all users.', 'content-visibility-specific-users')));
}

/* harmony default export */ __webpack_exports__["default"] = (Object(_wordpress_compose__WEBPACK_IMPORTED_MODULE_2__["withInstanceId"])(ContentVisibilitySpecificUsersBodyControl));

/***/ }),

/***/ "./src/controls/content-visibility-specific-users.js":
/*!***********************************************************!*\
  !*** ./src/controls/content-visibility-specific-users.js ***!
  \***********************************************************/
/*! exports provided: ContentVisibilitySpecificUsersControl */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ContentVisibilitySpecificUsersControl", function() { return ContentVisibilitySpecificUsersControl; });
/* harmony import */ var _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @babel/runtime/helpers/defineProperty */ "./node_modules/@babel/runtime/helpers/defineProperty.js");
/* harmony import */ var _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _wordpress_element__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @wordpress/element */ "@wordpress/element");
/* harmony import */ var _wordpress_element__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__);
...
/* harmony import */ var _content_visibility_specific_users_panel_body__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./content-visibility-specific-users-panel-body */ "./src/controls/content-visibility-specific-users-panel-body.js");
...
function ContentVisibilitySpecificUsersControl(data) {
  ...
  if (!rulesEnabled || !contentVisibility) {
    return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__["createElement"])(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__["Disabled"], null, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__["createElement"])(_content_visibility_specific_users_panel_body__WEBPACK_IMPORTED_MODULE_6__["default"], {
      props: props
    }));
  }

  return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__["createElement"])(_content_visibility_specific_users_panel_body__WEBPACK_IMPORTED_MODULE_6__["default"], {
    props: props
  });
}
/**
...
function ContentVisibilitySpecificUsersFill() {
  return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__["createElement"])(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__["Fill"], {
    ...
    return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__["createElement"])(ContentVisibilitySpecificUsersControl, {
      props: fillProps
    });
  });
...
Object(_wordpress_plugins__WEBPACK_IMPORTED_MODULE_4__["registerPlugin"])('content-visibility-06-specific-users-fill', {
  render: ContentVisibilitySpecificUsersFill
}); // Register our visibility rule with the main plugin

Object(_wordpress_hooks__WEBPACK_IMPORTED_MODULE_5__["addFilter"])('contentVisibility.defaultContentVisibilityRules', 'content-visibility-specific-users/block-visibility-rules', registerContentVisibilityRule);
...
/* harmony import */ var _controls_content_visibility_specific_users__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./controls/content-visibility-specific-users */ "./src/controls/content-visibility-specific-users.js");
